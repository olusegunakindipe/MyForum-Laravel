        ...
        @if(!in_array(request()->path(), ['login','register','password/email','password/reset']))
            <main class="container py-4">            
                <div class="row">
                    <div class="col-md-4">
                        @Auth
                            <a href="{{route('discussions.create')}}" class="btn btn-info btn-lg my-3" style="width:100%; color:#fff">Add Discussion</a>

                        @else
                        <a href="{{route('discussions.create')}}" class="btn btn-info btn-lg my-3" style="width:100%; color:#fff">Sign In to Add Discussion</a>
                                ...
                                <ul class="list-group">
                                    @foreach($topics as $topic)
                                        <li class="list-group-item">
                                            <a href="{{route('discussions.index')}}?topic={{$topic->slug}}">
                                            {{$topic->name}}
                                            </a>
